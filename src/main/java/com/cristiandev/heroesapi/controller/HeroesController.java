package com.cristiandev.heroesapi.controller;

import com.cristiandev.heroesapi.document.Heroes;
import com.cristiandev.heroesapi.repository.HeroesRepository;
import com.cristiandev.heroesapi.service.HeroesService;
...
public class HeroesController {
    ...
    public Mono<HttpStatus> deletebyIdHero(@PathVariable String id){
        ...
        log.info("deletr a hero with id{}", id);
